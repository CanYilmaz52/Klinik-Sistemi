...
namespace DisKlinik
{
    internal class Tahlil
    {
        public void TahlilEkle(string query)
        {
        ...
        public void TahlilSil(string query)
        {
            ConnectionString MyConnection = new ConnectionString();
            SqlConnection baglanti = MyConnection.GetCon();
            SqlCommand komut = new SqlCommand();
        ...
        public DataSet ShowTahlil(string query)
        {
            ConnectionString MyConnection = new ConnectionString();
            SqlConnection baglanti = MyConnection.GetCon();
